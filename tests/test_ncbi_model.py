...
from virtool_cli.ncbi.model import NCBIGenbank, NCBILineage, NCBIRank, NCBITaxonomy
...
class TestParseGenbank:
    ...
    def test_sequence_validation_fail(self, scratch_cache: NCBICache):
...
class TestParseTaxonomy:
    ...
    def test_with_rank(
        ...
        """
        record = scratch_cache.load_taxonomy(1016856)
...
def test_create_lineage_item_alias(snapshot: SnapshotAssertion):
