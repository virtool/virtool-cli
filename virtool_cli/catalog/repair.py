...
async def fill_missing_taxids(catalog_path: Path, logger: BoundLogger = get_logger()):
    """
...
async def rename_listings(catalog_path: Path, logger: BoundLogger = get_logger()):
    """
